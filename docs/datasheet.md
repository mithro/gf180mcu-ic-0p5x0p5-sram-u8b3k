# gf180mcu_ic_0p5x0p5_sram_u8b3k Datasheet

GF180MCU 0.5x0.5 SRAM Test Chip - 3KB unified 8-bit bus
## General Description

gf180mcu_ic_0p5x0p5_sram_u8b3k is an SRAM-based memory chip designed for the GF180MCU process.
It provides 3072 words of 8-bit storage using 6
embedded SRAM macros.

## Features

- 3072 bytes (24576 bits) total capacity
- 12-bit address bus
- 8-bit data bus
...
| addr[11:0] | Input | 12 | CMOS | Address bus |
...
The memory is organized as 3072 words of 8 bits each.
The address space spans from 0x0000 to 0x0BFF.
...
Generated configuration: gf180mcu_ic_0p5x0p5_sram_u8b3k
- Slot: 0p5x0p5
- SRAM count: 6
